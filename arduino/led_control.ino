...
// Latido de Corazón (Para "White Noise")
void heartbeatMode() {
  ...
  // Se multiplica la intensidad para lograr un rojo/naranja cálido y profundo
  int r = 255 * intensity;
  int g = 20 * intensity;  
  int b = 0;
...
// Luz Utilitaria: Blanco Frío brillante
void utilityLight() {
...
// Rutina de Día: Amanecer (Fade-in Azul)
void dayRoutineMode() {
...
// Rutina de Noche: Atardecer (Fade-out Rojo)
